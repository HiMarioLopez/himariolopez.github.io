      ...
      <GridContainer justify="center">
        <GridItem xs={11} sm={11} md={6}>
          <div className={classNames(classes.description, classes.textCenter)}>
            ...
            <p>
              I hold work experience in hospitality, sales, fundraising, product
              design, program management, and software development.
            </p>
            <p>
              The three goals I've set for myself are: Meet wonderful people,
              build amazing things, and learn a lot while doing both. I hope you
              can help me to achieve them in some way. Thank you for visiting my
              site, I hope you've found what you were looking for. 🤠
            </p>
          </div>
        </GridItem>
      </GridContainer>
