                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        ...
                        <div className={classes.cardDescriptionWhite}>
                          ...
                          managers, engineers, VPs, technologists. Devised
                          recommendations for team prior to leaving.
                          <br />
                          <div style={badgeStyle}>
                  ...
                  <Card className={classes.cardRotate}>
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        ...
                        <div className={classes.cardDescriptionWhite}>
                          Led research study on Reinforcment Learning and how we
                          could better leverage the technology within the energy
                          industry. Developed, tested, and deployed models onto
